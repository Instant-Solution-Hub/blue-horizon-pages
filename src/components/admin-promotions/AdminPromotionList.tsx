...
import { Package, Tag, Megaphone, Calendar, Users, Gift, Pencil, Trash2 } from "lucide-react";
...
interface AdminPromotionListProps {
  ...
  onEditPromotion: (promotion: PromotionApi) => void;
  onDeletePromotion: (promotion: PromotionApi) => void;
}

const AdminPromotionList = ({ promotions, onEditPromotion, onDeletePromotion }: AdminPromotionListProps) => {
