...
interface UpdatePromotionModalProps {
  ...
  promotion: PromotionApi | null;
  onUpdate: (id: string, promotion: UpdatePromotionFormData) => void;
}

export interface UpdatePromotionFormData {
  name: string;
  description: string;
...
const UpdatePromotionModal = ({
  ...
  useEffect(() => {
    if (promotion) {
      ...
      // Set benefitInput as comma-separated string for easy editing
      setBenefitInput(promotion.benefitsAndOffers);
    }
  }, [promotion]);
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="update-name">Promotion Name *</Label>
            <Input
              id="update-name"
              value={formData.name}
