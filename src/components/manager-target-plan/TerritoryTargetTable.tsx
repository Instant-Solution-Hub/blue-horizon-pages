...
interface TerritoryTargetTableProps {
  data: TerritoryData[];
  onUpdateData: (id: number, field: string, value: number) => void;
}
...
const TerritoryTargetTable = ({ data, onUpdateData }: TerritoryTargetTableProps) => {
  ...
  const handleSave = (id : number) => {
    if (editValues) {
      onUpdateData(id, "weeklyPrimarySale", editValues.weeklyPrimarySale);
      onUpdateData(id, "weeklySecondarySale", editValues.weeklySecondarySale);
      onUpdateData(id, "totalSubstockistStock", editValues.totalSubstockistStock);
    }
