...
export function SlotRequestsModal({
  ...
  // const processedRequests = requests.filter((r) => r.status.toLowerCase() !== "pending");
    ...
    <div className="border rounded-lg p-4 space-y-2">
      ...
      <div className="text-sm text-muted-foreground space-y-1">
        <p>
          ...
          {request.visitType} — {request.targetName}
        </p>

         <p>
          <span className="font-medium text-foreground">Requested Slot:</span> {request.requestedSchedule}
        </p>

        <p>
          <span className="font-medium text-foreground">Current Slot:</span> {request.currentSchedule}
        </p>
        <p>
      ...
      {request.status.toLowerCase() === "pending" && onApprove && onReject && (
